...
export const COLUMN_TEMPLATES: ColumnTemplate[] = [
  ...
  },
  {
    ...
    columns: [
      { name: 'Deponent Name', type: 'text', prompt: 'What is the full name of the person being deposed?', width: 200 },
      ...
      { name: 'Key Admissions', type: 'text', prompt: 'List any key admissions or damaging statements made by the deponent.', width: 400 },
